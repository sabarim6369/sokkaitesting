...
const prevImage1 = () => {
  ...
  <div><h1 className='hidden lg:block'>hello</h1></div>
  ...
  <div className="flex items-center space-x-4">
        ...
        <div className="absolute left-0 mt-2 w-40 bg-white border border-gray-200 rounded-md shadow-lg z-50">
          <ul className="text-gray-700 text-base">
            <li className="hover:bg-gray-100">
              <Link href="/frontend/Products/shirts" className="block px-4 py-2">
                Shirts
              </Link>
            </li>
            <li className="hover:bg-gray-100">
              <Link href="/frontend/Products/trousers" className="block px-4 py-2">
                Trousers
              </Link>
            </li>
            <li className="hover:bg-gray-100">
              <Link href="/frontend/Products/pants" className="block px-4 py-2">
                Pants
              </Link>
            </li>
          </ul>
    ...
    <Link href="/frontend/Products/wishlist">
      <button className="text-gray-700 hover:text-blue-500 p-2" aria-label="Wishlist">
    ...
    <Link href="/frontend/cart">
      <button className="text-gray-700 hover:text-blue-500 p-2" aria-label="Cart">
        <i className="fas fa-shopping-cart text-lg lg:text-2xl"></i>
      </button>
    </Link>
  </div>

  {/* Mobile Search Bar (Visible when toggled on small screens) */}
  {showSearch && (
    <div
      ref={searchRef}
  ...
  {/* Text Section */}
  <div className="w-full lg:w-1/2 text-center lg:text-left mt-4 lg:mt-0 p-6 bg-indigo-100 rounded-lg shadow-md border-l-4 border-indigo-500">
    <h4 className="text-xl font-semibold uppercase mb-2 text-indigo-700">
    ...
    <div className="flex justify-start items-center">
      ...
      <span className="ml-2 text-indigo-600 font-semibold">Limited Time Offer</span>
    </div>
  </div>
</section>
